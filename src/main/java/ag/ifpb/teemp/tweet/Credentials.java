...
public class Credentials {
    ...
    private final String consumerKey = "IRUJ0ACT2Qse3PtjmbSp4A9F4";
    private final String consumerSecret = "SJZBjxDo8whVtBcxWebxKpRImtW1MvZwiVhJ43JON5OAhKStZQ";
